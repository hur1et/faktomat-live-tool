...
b′ ist **kein** klassisches Response-Criterion (keine allgemeine
Ja-Sage-Tendenz), sondern ein **Asymmetrie-Index der Genauigkeit** über die
Ideologie-Kongruenz der korrekten Antwort. Positiv = genauer bei
rechts-kongruenten, negativ = genauer bei links-kongruenten Aussagen.

## Anonymität (was auf die Leinwand darf)

Nur Verteilungen (Histogramm/KDE), nie Einzelpunkte; Reveal erst ab 15
Teilnahmen (erzwingt der Server); kein Leaderboard, kein „besser als X %".
Individuelles Feedback sehen Teilnehmende ausschließlich privat auf dem
eigenen Gerät.
